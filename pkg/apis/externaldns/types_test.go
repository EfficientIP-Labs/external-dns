...
var (
	...
	overriddenConfig = &Config{
		...
		EfficientIPHost:             "127.0.0.1",
		EfficientIPPort:             8383,
		EfficientIPUsername:         "user-admin",
		EfficientIPPassword:         "password",
		EfficientIPSSLVerify:        false,
	...
	for _, ti := range []struct {
		...
		},
		{
			...
			args: []string{
				...
				"--efficientip-host=127.0.0.1",
				"--efficientip-port=8383",
				"--efficientip-username=user-admin",
				"--efficientip-password=password",
				"--no-efficientip-ssl-verify",
		...
		},
		{
			...
			envVars: map[string]string{
				...
				"EXTERNAL_DNS_EFFICIENTIP_HOST":                "127.0.0.1",
				"EXTERNAL_DNS_EFFICIENTIP_PORT":                "8383",
				"EXTERNAL_DNS_EFFICIENTIP_USERNAME":            "user-admin",
				"EXTERNAL_DNS_EFFICIENTIP_PASSWORD":            "password",
				"EXTERNAL_DNS_EFFICIENTIP_SSL_VERIFY":          "0",
